...
function in_range(pos, range)
  if (pos.line > range.start.line and pos[1] < range['end'].line) then
    return true
  elseif pos.line == range.start.line and pos[1] == range['end'].line then
    return pos.character >= range.start.character and pos[2] <= range['end'].character
