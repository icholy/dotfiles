...
map <Leader>f :Unite -toggle -start-insert file_rec<CR>
map <Leader>b :Unite -toggle -start-insert buffer<CR>
map <Leader>g :Unite -auto-preview -auto-highlight ack<CR>
